...
Candidate-level data on primary elections for U.S. state legislatures, covering all 50 states from 1990 to 2024. The dataset includes vote totals, primary runoff results, incumbency status, and crosswalk identifiers linking candidates to the [Klarner](https://doi.org/10.7910/DVN/DGUMFI) general election data and [DIME](https://data.stanford.edu/dime) campaign finance records.
